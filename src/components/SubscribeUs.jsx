  ...
  return (
    <div className="hidden md:block h-96 w-full bg-[#DDD] py-20 px-80">
      <div className="text-center">
        ...
        <div className="md:relative md:w-3/4 mt-10 text-center ml-32">
          <input
            type="email"
          ...
          <button className="md:absolute md:inset-y-0 md:right-0 px-20 py-2 bg-black text-white rounded-3xl">
            Subscribe
          </button>
        </div>
        <div className="md:flex md:items-center text-center mt-10 ml-52">
          <input
            type="checkbox"
            id="agree"
